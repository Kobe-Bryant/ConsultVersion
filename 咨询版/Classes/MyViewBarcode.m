...
- (void) generateQRCodeWithView: (UIView *) view 
{
	...
	CGSize labelSize = [titleString sizeWithFont:[UIFont systemFontOfSize:18]							
								 constrainedToSize:CGSizeMake(260, 34) 							
									 lineBreakMode:UILineBreakModeCharacterWrap];
	UILabel *title = [[UILabel alloc] initWithFrame:CGRectMake(30,270, labelSize.width, labelSize.height)];
	...
	CGSize urlLabelSize = [url sizeWithFont:[UIFont systemFontOfSize:14]							
							   constrainedToSize:CGSizeMake(260, 34) 							
								   lineBreakMode:UILineBreakModeCharacterWrap];
	UILabel *urlLable = [[UILabel alloc] initWithFrame:CGRectMake(30,300, urlLabelSize.width, urlLabelSize.height)];
	urlLable.text = url;
